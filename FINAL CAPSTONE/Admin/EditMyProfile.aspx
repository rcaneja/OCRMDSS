<%@ Page Title="Edit My Profile" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="EditMyProfile.aspx.cs" Inherits="Admin_EditMyProfile" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="jumboTron" Runat="Server">
        <h1>Edit Profile</h1>
        <p class="lead">Update your credentials</p>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" Runat="Server">
    ...
    <br />
    <asp:Label ID="lblFirstName" runat="server" Text="First Name" CssClass="labellarge"></asp:Label>
    <br />
    <asp:TextBox ID="txtFN" runat="server" CssClass="input-xlarge" 
        placeholder="First Name" Enabled="False"></asp:TextBox>
    <br />
    <asp:Label ID="lblLN" runat="server" Text="Last Name" CssClass="labellarge"></asp:Label>
    <br />
