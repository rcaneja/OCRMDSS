...
public partial class GeneralManager_OrderDetails : System.Web.UI.Page
{
    ...
    void getOrderDetails()
    {
        ...
        {
            Response.Redirect("http://localhost:12345/FINAL CAPSTONE/GeneralManager/SearchOrders.aspx");
        }
        con.Close();
    }
}