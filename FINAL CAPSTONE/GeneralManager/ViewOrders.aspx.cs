...
public partial class GeneralManager_ViewOrders : System.Web.UI.Page
{
    ...
    void getOrderList()
    {
        ...
        com.Connection = con;
        com.CommandText = "SELECT * FROM Users AS A INNER JOIN Orders AS B  ON A.userID = B.userID INNER JOIN CustomersInfo AS C ON A.userName = C.userName WHERE B.orderStatus = 'Pending' ORDER BY B.orderDate";
    ...
    protected void btnViewDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("http://localhost:12345/FINAL%20CAPSTONE/GeneralManager/OrderDetails.aspx?orderID=" + orderID.ToString());
    }
    ...
    void getOrder(string column, string keyword)
    {
        ...
        SqlCommand com = new SqlCommand();
        com.Connection = con;
        com.CommandText = "SELECT * FROM Users AS A INNER JOIN Orders AS B  ON A.userID = B.userID INNER JOIN CustomersInfo AS C ON A.userName = C.userName WHERE B.orderStatus = 'Pending' AND " +
            "WHERE " + column + " LIKE '%" + keyword + "%' ORDER BY B.orderDate";
