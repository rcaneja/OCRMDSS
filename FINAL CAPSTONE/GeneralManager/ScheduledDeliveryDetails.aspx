<%@ Page Title="" Language="C#" MasterPageFile="~/GeneralManager/GeneralManager.master" AutoEventWireup="true" CodeFile="ScheduledDeliveryDetails.aspx.cs" Inherits="GeneralManager_ScheduledDeliveryDetails" Debug="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
     <asp:Label ID="lblNoti" runat="server" CssClass="alert alert-info alert-block lineheight40 text-center" Visible="false"><i class="icon-info-sign"></i></asp:Label>
        ...
        <hr />
            ...
            <br /><br />
            <a href="http://localhost:12345/FINAL%20CAPSTONE/GeneralManager/ViewScheduledDeliveries.aspx" class="btn btn-primary btn-large pull-right width175px">Back</a>
            <br />
</asp:Content>
