...
public partial class GeneralManager_CustomerInfo : System.Web.UI.Page
{
        ...
        if (Convert.ToInt32(Session["userType"]) == 4)
        {
            if (Session["isApproved"].ToString() == "Approved")
            {
                if (Request.QueryString["customerID"] != null)
                {
                    ...
                    Response.Redirect("http://localhost:12345/FINAL%20CAPSTONE/GeneralManager/SearchCustomers.aspx");
            }
            else
    ...
    void getCustomer(string customerID)
    {
     ...
     {
         Response.Redirect("http://localhost:12345/FINAL CAPSTONE/GeneralManager/SearchCustomers.aspx");
     }
}