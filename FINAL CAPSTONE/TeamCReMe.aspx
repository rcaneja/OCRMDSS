<%@ Page Title="Team CReMe" Language="C#" AutoEventWireup="true" CodeFile="TeamCReMe.aspx.cs" Inherits="TeamCReMe" Debug="true" %>
...
<html lang="en">
  ...
  <body>      
    <form id="frmTeamCreme" runat="server">
    <div id="wrap">
    <!-- Navbar================================================== -->
...
<!-- Masthead================================================== -->
    <header class="jumbotron subhead" id="overview" style="height:600px;">
      <div class="container">
            <center><h1 style="font-family: Segoe Print; color: #0000FF">&nbsp;</h1>
            <h1 style="font-family: 'Sakkal Majalla'; color: #FF0066; font-size: 40pt;"><strong>Team CReMe</strong></h1>
            </center>
        <br />
            <center>
            Developers<em><span style="font-size: 13pt">:</span></em> <br /><br />
            <strong><span style="font-size: medium">
            <span style="font-family: 'Khmer UI'"><span class="style1">Caneja, Renalyn P. <br /><br />
            Hou, Michelle A. <br /><br />
            Nuqui, Cassandra Lou G.</span> </span> <br /> <br />
            </span></strong>
            </center>    
      </div>
    </header>
