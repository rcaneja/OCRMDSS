<%@ Page Title="Login" Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" Debug="true"%>
...
<html lang="en">
  ...
  <body style="background: url(http://localhost:12345/FINAL%20CAPSTONE/assets/img/log.jpeg); background-size:100%; height:98px;">      
    ...
    <div class="form-actions pull-right borRad5 height100" style="margin: 75px 0 122px 0;">
        <asp:Label ID="lblNoti" runat="server" CssClass="alert alert-danger alert-block lineheight40 text-center boldFont" Visible="false"></asp:Label>
        <h3>Login</h3>
        <hr />
        <br />
        ...
        <br />
        <br /><hr />
        <a href="http://localhost:12345/FINAL%20CAPSTONE/Customers/Registration.aspx">Not yet a member? Register here.</a>
        <br />
        <br />
