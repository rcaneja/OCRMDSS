<%@ Page Title="" Language="C#" MasterPageFile="~/WarehouseManager/Masterpage.master" AutoEventWireup="true" CodeFile="OrderDetails.aspx.cs" Inherits="WarehouseManager_OrderDetails" Debug="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" Runat="Server">
     <asp:Label ID="lblNoti" runat="server" CssClass="alert alert-info alert-block lineheight40 text-center" Visible="false"><i class="icon-info-sign"></i></asp:Label>
        ...
        <hr />
            ...
            <br /><br />
            <a href="http://localhost:12345/FINAL%20CAPSTONE/WarehouseManager/SearchOrders.aspx" class="btn btn-primary btn-large pull-right width175px">Back</a>
            <br />
</asp:Content>
