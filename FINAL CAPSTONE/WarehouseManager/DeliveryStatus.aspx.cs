...
public partial class WarehouseManager_DeliveryStatus : System.Web.UI.Page
{
    ...
    void getOrderList()
    {
        ...
        com.Connection = con;
        com.CommandText = "SELECT * FROM Users AS A INNER JOIN Orders AS B  ON A.userID = B.userID INNER JOIN CustomersInfo AS C ON A.userName = C.userName WHERE B.orderStatus='Approved' AND B.deliveryStatus = 'Pending' ORDER BY CONVERT(DateTime, orderDate,101)  DESC";
    ...
    protected void btnViewDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("http://localhost:12345/FINAL CAPSTONE/WarehouseManager/UpdateDeliveryStatus.aspx?orderID=" + orderID.ToString());
    }
    ...
    void getOrder(string column, string keyword)
    {
        ...
        SqlCommand com = new SqlCommand();
        com.Connection = con;
        com.CommandText = "SELECT * FROM Users AS A INNER JOIN Orders AS B  ON A.userID = B.userID INNER JOIN CustomersInfo AS C ON A.userName = C.userName WHERE B.orderStatus='Approved' AND " + column + " LIKE '%" + keyword + "%'";
