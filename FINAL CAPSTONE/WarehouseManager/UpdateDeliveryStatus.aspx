<%@ Page Title="" Language="C#" MasterPageFile="~/WarehouseManager/Masterpage.master" AutoEventWireup="true" CodeFile="UpdateDeliveryStatus.aspx.cs" Inherits="WarehouseManager_UpdateDeliveryStatus" Debug="true" %>
     ...
     <asp:Label ID="lblNoti" runat="server" CssClass="alert alert-info alert-block lineheight40 text-center" Visible="false"><i class="icon-info-sign"></i></asp:Label>
        ...
        <hr />
            ...
            <br /><br />
                ...
                <asp:Button ID="btnDelivered" runat="server" onclick="btnDelivered_Click" Text="Delivered" CssClass="btn btn-primary width150px  btn-large" />
                <asp:Button ID="btnPickedUp" runat="server" onclick="btnPickedUp_Click" Text="Picked Up" CssClass="btn btn-primary marginBoth width150px btn-large"/> 
            ...
            <br />
            <asp:GridView ID="grd" runat="server" Visible="False" AutoGenerateColumns="False" ShowHeader="false">
                    <Columns>  
                    <asp:BoundField DataField="productSerialNo" SortExpression="productSerialNo" ></asp:BoundField>
                    </Columns>
            </asp:GridView>
</asp:Content>
