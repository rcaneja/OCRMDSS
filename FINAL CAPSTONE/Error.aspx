<%@ Page Title="Error" Language="C#" AutoEventWireup="true" CodeFile="Error.aspx.cs" Inherits="Error" Debug="true" %>
...
<!-- Masthead================================================== -->
    <header class="jumbotron subhead" id="overview">
      <div class="container">
        <center><h1 style="font-family: 'Sakkal Majalla'; color: red; font-size: 40pt;"><strong>Oops! Error found!</strong></h1>
          <img src="assets/img/062.jpg" style="width:65%; height:650%;" /></center>
      </div>
    </header>        
    </div>
