<%@ Page Title="" Language="C#" MasterPageFile="~/Secretary/MasterPage.master" AutoEventWireup="true" CodeFile="InventoryStatus.aspx.cs" Inherits="Secretary1_InventoryStatus" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" Runat="Server">
    <h2>Inventory Status</h2>
        ...
        <br />
        <br />
        <asp:GridView ID="grdInventory" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
        ...
        BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" 
            OnPageIndexChanged="grdInventory_PageIndexChanged" OnPageIndexChanging="grdInventory_PageIndexChanging" >
                <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                            <a href="http://localhost:12345/FINAL%20CAPSTONE/Secretary/InventoryDetails.aspx?inventoryID=<%# Eval("inventoryID") %>" class="btn btn-primary text-center pull-right">View Details</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                </Columns>
