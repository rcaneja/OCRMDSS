<%@ Page Title="" Language="C#" MasterPageFile="~/Secretary/MasterPage.master" AutoEventWireup="true" CodeFile="SearchOrders.aspx.cs" Inherits="Secretary1_SearchOrders" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" Runat="Server">
    <h2>Search Orders</h2>
        ...
        <asp:GridView ID="grdOrders" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="Black" CssClass="table table-hover width100"
            ...
            BackColor="White" BorderColor="#CCCCCC" BorderWidth="1px" BorderStyle="None" GridLines="Horizontal" AllowPaging="True">
                ...
                <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                            <a href="http://localhost:12345/FINAL%20CAPSTONE/Secretary/OrderDetails.aspx?orderID=<%# Eval("orderID") %>" class="btn btn-primary text-center pull-right">View Details</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
        ...
        <asp:Button ID="btnValidateOrder" runat="server" Text="Validate Orders" CssClass="btn btn-primary btn-large pull-right marginBoth" OnClick="btnValidateOrders_Click" />
        <br /><br /><br /><br />
