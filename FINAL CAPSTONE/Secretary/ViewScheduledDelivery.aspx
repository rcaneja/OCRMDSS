<%@ Page Title="" Language="C#" MasterPageFile="~/Secretary/MasterPage.master" AutoEventWireup="true" CodeFile="ViewScheduledDelivery.aspx.cs" Inherits="Secretary1_ViewScheduledDelivery" %>
        ...
        <asp:GridView ID="grdOrders" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="Black" CssClass="table table-hover width100"
            ...
            BackColor="White" BorderColor="#CCCCCC" BorderWidth="1px" BorderStyle="None" GridLines="Horizontal">
                ...
                <Columns>
                        ...
                        <asp:TemplateField>
                        <ItemTemplate>
                        <a href="http://localhost:12345/FINAL%20CAPSTONE/Secretary/ScheduledDeliveryDetails.aspx?orderID=<%# Eval("orderID") %>" class="btn btn-primary text-center pull-right">View Details</a>
                        </ItemTemplate>
                        </asp:TemplateField>
                </Columns>
