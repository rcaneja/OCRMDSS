<%@ Page Title="View Customers" Language="C#" MasterPageFile="~/Secretary/MasterPage.master" AutoEventWireup="true" CodeFile="ViewCustomers.aspx.cs" Inherits="Secretary_ViewCustomers" Debug="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" Runat="Server">
    ...
    <asp:FilteredTextBoxExtender ID="txtKeyword_FilteredTextBoxExtender" 
            ...
            InvalidChars=
"&quot;&<>@ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðòóôõö÷øùúûüýþÿŒœŠšŸƒˆ˜–—‘’‚“”„‹›¡¢£¤¥€¦§¨©ª«¬®¯ °±²³´µ¶•¸¹º»¼½¾¿ΓΔΘΛΞΠΣΦΨΩαβγδεζηθικλμνξοπρςστυφχψωϑϒϖ†‡•…‰′″‾⁄℘ℑℜ™ℵ←↑→↓↔↵⇐⇑⇒⇓⇔∀∂∃∅∇∈∉∋∏∑−∗√∝∞∠∧∨∩∪∫∴∼≅≈≠≡≤≥⊂⊃⊄⊆⊇⊕⊗⊥⋅⌈⌉⌊⌋⟨⟩◊♠♣♥♦&ensp;&emsp;&thinsp;&zwnj;&zwj;&lrm;&rlm;"
    ...
    <hr />
            <asp:GridView ID="grdCustomers" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href="http://localhost:12345/FINAL%20CAPSTONE/Secretary/ValidateCustomers.aspx?customerID=<%# Eval("customerID") %>" class="btn btn-primary text-center pull-right">View Details</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
                    <span class="boldFont text-center label label-warning">No new customer to validate found!</span>
                </EmptyDataTemplate>
