<%@ Page Title="" Language="C#" MasterPageFile="~/Secretary/Masterpage.master" AutoEventWireup="true" CodeFile="CustomerDetails.aspx.cs" Inherits="Secretary1_CustomerDetails" Debug="true" %>
    ...
    <p class="alert alert-danger alert-block lineheight40 boldFont text-center" id="pError" runat="server"><asp:Label ID="lblError" runat="server" CssClass="lineheight40 boldFont" Visible="false"></asp:Label></p>
       ...
       <dl class="dl-horizontal">
           ...
           <dt>Email Address:</dt>
            ...
            <br />
            <a href="http://localhost:12345/FINAL%20CAPSTONE/Secretary/SearchCustomers.aspx" class="btn btn-primary btn-large pull-left width175px">Back</a>
            <br />
</asp:Content>
