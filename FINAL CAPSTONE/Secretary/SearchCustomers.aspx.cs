...
public partial class Secretary_SearchCustomers : System.Web.UI.Page
{
    ...
    void getCustomerList()
    {
        ...
        SqlCommand com = new SqlCommand();
        com.Connection = con;
        com.CommandText = "SELECT * FROM Users AS A INNER JOIN CustomersInfo AS B ON A.userName=B.userName WHERE A.userType = 1 ORDER BY A.validation ASC";
